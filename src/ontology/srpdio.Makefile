...
age_x_disability.owl: ../patterns/acs5_variable_sheets/age_x_disability.csv ../patterns/acs5_variable_sheets/age_x_disability.yaml curie_map.yaml
	dosdp-tools generate --obo-prefixes=true --table-format=csv --template=../patterns/acs5_variable_sheets/age_x_disability.yaml --outfile=patterns/age_x_disability.tmp.owl --infile=../patterns/acs5_variable_sheets/age_x_disability.csv
	$(ROBOT) annotate --input patterns/age_x_disability.tmp.owl -O http://purl.obolibrary.org/obo/srpdio/age_x_disability.owl --output patterns/age_x_disability.owl && rm patterns/age_x_disability.tmp.owl
