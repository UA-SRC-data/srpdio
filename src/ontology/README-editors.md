These notes are for the EDITORS of srpdio
...
Make sure you have an ID range in the [idranges file](srpdio-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [srpdio-edit.owl](srpdio-edit.owl)

** DO NOT EDIT srpdio.obo OR srpdio.owl in the top level directory **

[../../srpdio.owl](../../srpdio.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/UA-SRC-data/srpdio) for details.
 ...
 * [srpdio-idranges.owl](srpdio-idranges.owl)
 ...
 * https://github.com/UA-SRC-data/srpdio/releases
 * https://github.com/UA-SRC-data/srpdio/releases/new
...
what is in the `owl:versionIRI` of the derived srpdio.owl (`data-version` in
srpdio.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/srpdio.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/srpdio/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/UA-SRC-data/srpdio.svg?branch=master)](https://travis-ci.org/UA-SRC-data/srpdio)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/UA-SRC-data](https://travis-ci.org/profile/UA-SRC-data)
 2. click the "Sync account" button
 3. Click the tick symbol next to srpdio
