 ...
 * [srpdio.yml](srpdio.yml)
     * Determines how your purl.obolibrary.org/obo/srpdio/ redirects will be handled
     ...
     * Paste in the contents of [srpdio.yml](srpdio.yml)
 ...
 * [srpdio.md](srpdio.md)
     ...
     * Paste in the contents of [srpdio.md](srpdio.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
